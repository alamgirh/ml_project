...
if __name__ == '__main__':
    ...
    for epoch in range(num_epochs):
        for i, (images, labels, cont_labels, name) in enumerate(train_loader):
            ...
            #loss_yaw = criterion(loss(yaw), loss(label_yaw))
            #loss_pitch = criterion(loss(pitch), loss(label_pitch))
            #loss_roll = criterion(loss(roll), loss(label_roll))
            #print(yaw.size())
            #print(label_yaw.size())
            ...
            #loss_reg_yaw = alpha * loss_reg_yaw
            #loss_reg_pitch = alpha * loss_reg_pitch
            #loss_reg_roll = alpha * loss_reg_roll
            ...
            #if (i+1) % 100 == 0:
            #    print('Epoch [%d/%d], Iter [%d/%d] Losses: Yaw %.4f, Pitch %.4f, Roll %.4f'
            #           %(epoch+1, num_epochs, i+1, len(pose_dataset)//batch_size, loss_reg_yaw.item(), loss_reg_yaw.item(), loss_reg_yaw.item()))
